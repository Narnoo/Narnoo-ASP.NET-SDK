...
<asp:Content ID="Content3" ContentPlaceHolderID="body" runat="server">
    ...
    <asp:Panel ID="panelSettings" runat="server">
        ...
        <UmbracoControls:Pane ID="paneAppkey" runat="server">
        ...
        <UmbracoControls:Pane ID="paneSecretkey" runat="server">
    ...
    <asp:Panel ID="panelDetail" runat="server">
        ...
        <UmbracoControls:Pane ID="pane1" runat="server">
        ...
        <UmbracoControls:Pane ID="pane2" runat="server">
        ...
        <UmbracoControls:Pane ID="pane3" runat="server">
        ...
        <UmbracoControls:Pane ID="pane4" runat="server">
        ...
        <UmbracoControls:Pane ID="pane5" runat="server">
        ...
        <UmbracoControls:Pane ID="pane6" runat="server">
        ...
        <UmbracoControls:Pane ID="pane7" runat="server">
            ...
            <UmbracoControls:Pane ID="pane12" runat="server">
            ...
            <UmbracoControls:Pane ID="pane13" runat="server">
