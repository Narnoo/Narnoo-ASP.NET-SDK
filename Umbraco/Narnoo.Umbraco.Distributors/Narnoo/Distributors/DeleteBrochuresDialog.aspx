<%@ Page Title="" Language="C#" MasterPageFile="../../Masterpages/umbracoDialog.Master" AutoEventWireup="true" CodeBehind="DeleteBrochuresDialog.aspx.cs" Inherits="Narnoo.Umbraco.Distributors.Narnoo.Distributors.DeleteBrochuresDialog" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="body" runat="server">
    ...
    <p>
        Please confirm deletion of the following <%= this.SelectedIds.Length %> brochure(s):
        ...
        <asp:Repeater ID="rptItems" runat="server">
            ...
            <ItemTemplate>
                <li data-itemid="<%# Container.DataItem  %>">
                    ...
                    <span>Brochure ID: <%# Container.DataItem %></span>
...
<asp:Content ID="Content4" ContentPlaceHolderID="footer" runat="server">
     <script type="text/javascript">
         ...
         $(function () {
             ...
             var processUrl = '/umbraco/narnoo/distributors/ProcessDeleteBrochure.ashx?';
             $('#btnConfirm').click(function (e) {
                 ...
                 $('.tasks li').each(function () {
                     var task = function (item) {
                         return function () {
                             var id = item.data("itemid");
                             var url = processUrl + '&brochure_id=' + id;
