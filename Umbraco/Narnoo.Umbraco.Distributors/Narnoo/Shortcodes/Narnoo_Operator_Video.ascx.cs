...
//progress_color
    ...
    public partial class Narnoo_Operator_Video : ShortcodeBase
    {
        ...
        public override string RenderContent()
        {
            var content = "<div style='height: " + this.height + "px; width: " + this.width + "px;'>"
                   + "  <div style='height: " + this.height + "px; width: " + this.width + "px;' class='narnoo_video' data-id='" + this.id + "' data-count='" + this.VideoCount + "' data-width='" + this.width + "' data-height='" + this.height + "' data-operator-id='"+this.operator_id+"' id='narnooVideoFallback" + this.VideoCount + "'>"
        ...
        public override string RenderDesignContent()
        {
            ...
            if (this.operator_id.HasValue())
            {
                content += " operator_id='" + this.operator_id + "' ";
            }
